...
consulta. Para poupar a cota, cada execução consulta **no máximo 10 artistas novos por
pessoa**, os mais ouvidos primeiro e com uma pausa curta entre as chamadas. O cache se
completa nas execuções seguintes, e o rodapé avisa quantos artistas ainda faltam.
